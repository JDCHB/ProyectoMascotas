...
-- Tiempo de generación: 25-10-2024 a las 03:46:08
...
CREATE TABLE `collares_con_gps` (
  ...
  `ultima_ubicacion_registrada` varchar(50) NOT NULL,
...
--
-- Volcado de datos para la tabla `collares_con_gps`
--

INSERT INTO `collares_con_gps` (`id`, `numero_serie`, `ultima_ubicacion_registrada`, `nivel_bateria`, `fecha_hora_ultimo_reporte`, `id_mascota_vinculada`, `estado`) VALUES
(1, 'SN-2024-XYZ1234', 'Soledad', 100, '2024-10-24 20:49:27', 3, 1),
(2, 'GPS-2024-02A', 'Barranquilla', 80, '2024-10-25 03:25:34', 4, 1);
...
INSERT INTO `mascota` (`id`, `nombre`, `id_genero_mascota`, `id_tipo_mascota`, `id_propietario`, `fecha_hora`, `estado`) VALUES
(3, 'Susi', 2, 1, 7, '2024-10-24 20:43:30', 1),
(4, 'Firulais', 1, 1, 28, '2024-10-24 22:22:33', 1),
(5, 'Felix', 1, 2, 6, '2024-10-25 02:57:27', 1);
